...
function Topbar() {
  ...
  return (
    <Header style={{ background: "rgb(0 84 165)" }} className={styles.header}>
      <div className="">
        <img
          style={{
            color: "#000000",
          ...
          src="https://i.ibb.co/hXC9P2p/432896053-431139066148630-3207667354342141055-n-1.png"
      ...
      <div className={styles.navmenu} style={{ marginLeft: 20 }}>
        ...
        <NavLink
          ...
          to="/product-list/65fd67f2207e1639f49dc016"
          activeStyle
        >
          Sản phẩm
        </NavLink>
        <NavLink
          className={styles.navlink}
          to="/product-list/6625ec4336500b652f123eeb"
          activeStyle
        >
          Sách nói
        </NavLink>
